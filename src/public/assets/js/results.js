async function loadResult(specificSemester) {
    ...
    try {
        ...
        const passedCount = subjects.filter(s => s.marks >= 60).length;
                            ...
                            <table class="w-full text-left border-collapse">
                                <thead class="bg-slate-50 border-b border-slate-200">
                                    <tr>
                                        ...
                                        <th class="px-6 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest text-center">Marks</th>
                                    ...
                                    ${subjects.map((s, i) => {
                                        ...
                                        return `
                                            <tr class="hover:bg-slate-50/50 transition-colors">
                                                ...
                                                <td class="px-6 py-4 text-center">
                                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider ${s.marks >= 60 ? 'bg-emerald-100 text-emerald-700' : 'bg-rose-100 text-rose-700'}">
                                                        ${s.marks >= 60 ? 'Pass' : 'Fail'}
                                                    </span>
                                                </td>
                                            </tr>
                                        `;
